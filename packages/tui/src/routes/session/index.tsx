...
import { ICSCODE_BASE_MODE, useBindings, useCommandShortcut, useicscodeKeymap } from "../../keymap"
...
const GO_UPSELL_PROVIDERS = new Set(["icscode", "icscode-go"])
