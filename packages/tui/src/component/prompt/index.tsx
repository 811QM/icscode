...
import { registericscodeSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@icscode-ai/sdk/v2"
...
import { ICSCODE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useicscodeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.ICSCODE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
