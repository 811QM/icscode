...
const TEST_ONBOARDING = process.env.ICSCODE_TEST_ONBOARDING === "1"
...
const main = Effect.gen(function* () {
  ...
  process.env.ICSCODE_DISABLE_EMBEDDED_WEB_UI = "true"
  ...
  const port = yield* Effect.gen(function* () {
    const fromEnv = process.env.ICSCODE_PORT
    if (fromEnv) {
