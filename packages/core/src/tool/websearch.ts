...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.ICSCODE_WEBSEARCH_PROVIDER === "exa" || process.env.ICSCODE_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.ICSCODE_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("ICSCODE_EXPERIMENTAL") || truthy("ICSCODE_ENABLE_EXA") || truthy("ICSCODE_EXPERIMENTAL_EXA"),
    enableParallel: truthy("ICSCODE_ENABLE_PARALLEL") || truthy("ICSCODE_EXPERIMENTAL_PARALLEL"),
              ...
              const text =
                provider === "exa"
                  ...
                  : yield* callMcp(
                      ...
                      {
                        "User-Agent": `icscode/${InstallationVersion}`,
